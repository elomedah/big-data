...
| Poste | Budget estimé |
|-------|--------------:|
| Instances compute en fonctionnement continu actif | ~1 516 € |
| Instances compute avec redimensionnement 75 % du temps | ~536 € |
| Block Storage provisionné (~3,82 To) | ~363 € |
| Object Storage sauvegarde (~500 Go) | 4 € |
| Réserve technique (IP, snapshots, marge) | 100 € |
| **Total estimé en fonctionnement continu actif** | **~1 982 € HT** |
| **Total estimé avec redimensionnement 75 % du temps** | **~1 003 € HT** |
| **Budget plafond recommandé** | **1 200 € HT** |

> Le budget exact dépendra du type d'instances Scaleway choisi, de la région, de la durée réelle d'utilisation et du volume de stockage provisionné. Les montants ci-dessus sont des ordres de grandeur calculés à partir des tarifs publics PAR-1 des instances en septembre 2026, hors éventuelles remises et coûts non listés. Les machines doivent être arrêtées automatiquement hors séance pour rester dans le budget.
...
| CPU total | 94 vCPU |
| RAM totale | 204 Go |
| CPU total en mode réduit hors TP | 28 vCPU |
| RAM totale en mode réduit hors TP | 54 Go |
...
Pendant les séances de TP, les Workers, le Gateway et le Hadoop Master sont dimensionnés en mode actif. En dehors des séances, environ 75 % du temps, ils peuvent être redimensionnés en mode réduit, tout en conservant les volumes Block Storage attachés.
...
|-------|------------------------:|
| Bastion / Ansible | ~15 € |
| Gateway étudiants | ~31 € |
| Hadoop Master | ~173 € |
| Workers Hadoop x5 | ~1 297 € |
| Block Storage provisionné | ~363 € |
| Object Storage sauvegarde | ~4 € |
| Réserve technique | ~100 € |
| **Total indicatif si tout reste allumé en mode actif** | **~1 982 € HT / mois** |

## Estimation avec redimensionnement 75 % du temps

Hypothèse :

- 25 % du temps : Workers, Gateway et Hadoop Master en mode TP actif ;
- 75 % du temps : Workers, Gateway et Hadoop Master en mode réduit ;
- les volumes Block Storage restent conservés et facturés pendant toute la période.

| Poste | Estimation mensuelle HT |
|-------|------------------------:|
| Bastion / Ansible | ~15 € |
| Gateway étudiants, 25 % actif et 75 % réduit | ~13 € |
| Hadoop Master, 25 % actif et 75 % réduit | ~67 € |
| Workers Hadoop x5, 25 % en mode TP actif | ~324 € |
| Workers Hadoop x5, 75 % en mode réduit | ~117 € |
| Block Storage provisionné | ~363 € |
| Object Storage sauvegarde | ~4 € |
| Réserve technique | ~100 € |
| **Total indicatif avec redimensionnement** | **~1 003 € HT / mois** |

## Comparaison

| Mode d'utilisation | Coût mensuel estimé HT |
|--------------------|-----------------------:|
| Utilisation pédagogique avec redimensionnement 75 % du temps | ~1 003 € HT |
| Budget plafond recommandé | 1 200 € HT |
| Fonctionnement continu actif 24h/24 | ~1 982 € HT |
...
- le redimensionnement automatique des Workers, du Gateway et du Hadoop Master en mode réduit hors TP ;
...
Le fonctionnement continu peut augmenter fortement le coût mensuel par rapport à une utilisation pédagogique maîtrisée. Pour ce dimensionnement, l'écart estimé est d'environ **980 € HT par mois** entre un fonctionnement continu en mode actif et un redimensionnement global 75 % du temps.
